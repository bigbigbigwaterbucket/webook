...
const (
	CommentService_GetCommentList_FullMethodName = "/comv1.CommentService/GetCommentList"
	CommentService_GetMoreReplies_FullMethodName = "/comv1.CommentService/GetMoreReplies"
	CommentService_CreateComment_FullMethodName  = "/comv1.CommentService/CreateComment"
	CommentService_DeleteComment_FullMethodName  = "/comv1.CommentService/DeleteComment"
)
...
type CommentServiceClient interface {
	...
	GetMoreReplies(ctx context.Context, in *GetMoreRepliesReq, opts ...grpc.CallOption) (*GetMoreRepliesResp, error)
...
func (c *commentServiceClient) GetCommentList(ctx context.Context, in *GetCommentListReq, opts ...grpc.CallOption) (*GetCommentListResp, error) {
...
func (c *commentServiceClient) GetMoreReplies(ctx context.Context, in *GetMoreRepliesReq, opts ...grpc.CallOption) (*GetMoreRepliesResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetMoreRepliesResp)
...
type CommentServiceServer interface {
	...
	GetMoreReplies(context.Context, *GetMoreRepliesReq) (*GetMoreRepliesResp, error)
...
func (UnimplementedCommentServiceServer) GetCommentList(context.Context, *GetCommentListReq) (*GetCommentListResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCommentList not implemented")
}
func (UnimplementedCommentServiceServer) GetMoreReplies(context.Context, *GetMoreRepliesReq) (*GetMoreRepliesResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMoreReplies not implemented")
}
...
func _CommentService_GetMoreReplies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentServiceServer).GetMoreReplies(ctx, req.(*GetMoreRepliesReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CommentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "comv1.CommentService",
