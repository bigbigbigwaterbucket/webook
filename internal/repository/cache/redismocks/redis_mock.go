...
//
//	mockgen -package=redismocks -destination=D:/go_project/learning_go/webook/internal/repository/cache/redismocks/redis_mock.go github.com/redis/go-redis/v9 Cmdable
//
